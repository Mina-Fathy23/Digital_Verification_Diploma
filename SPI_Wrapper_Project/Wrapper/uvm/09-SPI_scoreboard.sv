...
`include "uvm_macros.svh"
    class SPI_scoreboard extends uvm_scoreboard;
        ...
        function void report_phase(uvm_phase phase);
            ...
            `uvm_info("report_phase",$sformatf("Slave: Total Successful Transactions: %0d",correct_count),UVM_MEDIUM);
            `uvm_info("report_phase",$sformatf("Slave: Total Failed Transactions: %0d",error_count),UVM_MEDIUM);
        endfunction
