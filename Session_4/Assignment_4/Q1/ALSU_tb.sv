...
module ALSU_tb ();
    ...
    initial begin
        ...
        inputs.opcode = OR; opcode = OR; direction = 1;
        ...
        cin       = 0; serial_in = 0;
        red_op_A  = 1; red_op_B  = 1;
        inputs.opcode = XOR; opcode = XOR; direction = 1;
        bypass_A  = 0; bypass_B  = 0;
        check_result();

        //Additional Tests for 100% functional Coverage 
        inputs.opcode = OR; opcode = OR;
