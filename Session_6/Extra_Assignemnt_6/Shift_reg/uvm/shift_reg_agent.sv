package shift_reg_agent_pkg;
    ...
    class shift_reg_agent extends uvm_agent;
        ...
        function void build_phase(uvm_phase phase);
            ...
            if(!uvm_config_db #(shift_reg_config)::get(this, "", "SHIFT_REG_CFG", shift_reg_cfg))
                `uvm_fatal("build_phase", "Unable to get configuration object");
            if(shift_reg_cfg.is_active == UVM_ACTIVE)begin
                driver = shift_reg_driver::type_id::create("driver", this);
                sequnecer = shift_reg_sequencer::type_id::create("sequnecer", this);
            end
        ...
        function void connect_phase(uvm_phase phase);
            ...
            if(shift_reg_cfg.is_active == UVM_ACTIVE)begin
                ...
                driver.seq_item_port.connect(sequnecer.seq_item_export);
            end
